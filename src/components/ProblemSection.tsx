    ...
    <section className="py-32 overflow-hidden">
      <div className="container mx-auto px-6">
        ...
        <div className="grid md:grid-cols-2 gap-8 items-end mb-16">
          ...
          <p className="text-muted-foreground text-lg leading-relaxed md:mb-2">
        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-5 mb-16">
          {cards.map((card, i) => {
            ...
            return (
              <div
                key={i}
                className={`rounded-2xl p-8 flex flex-col gap-5 bg-gradient-to-b ${card.color} border border-border relative overflow-hidden`}
              >
        ...
        {/* Solution bridge */}
        <div className="relative bg-foreground rounded-2xl p-8 md:p-10 overflow-hidden">
          {/* Decorative brand stripe */}
          <div className="absolute left-0 top-0 bottom-0 w-1.5 bg-brand rounded-l-2xl" />
          {/* Decorative large text — only shows on very wide screens where it can't overlap */}
